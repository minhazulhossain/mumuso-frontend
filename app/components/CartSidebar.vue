<template>
  <USlideover v-model="isCartOpen" :ui="{ width: 'max-w-md' }">
    <UCard class="flex flex-col h-full" :ui="{ body: { base: 'flex-1 overflow-y-auto' }, footer: { base: 'border-t' } }">
      <template #header>
      ...
      <div v-if="cartItems.length === 0" class="flex flex-col items-center justify-center py-12 text-center">
