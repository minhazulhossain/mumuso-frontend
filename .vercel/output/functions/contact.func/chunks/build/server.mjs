import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, toValue, useSlots, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, renderSlot, createTextVNode, toDisplayString, Fragment, renderList, toRef, isRef, inject, mergeModels, useModel, reactive, resolveComponent, ref, resolveDynamicComponent, getCurrentScope, onScopeDispose, onServerPrefetch, hasInjectionContext, watch, useAttrs, nextTick, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, createApp, useId, withAsyncContext, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, markRaw } from 'vue';
import { E as serialize, F as isEqual, G as defu, H as hash, p as parseQuery, I as klona, J as defuFn, K as hasProtocol, L as isScriptProtocol, M as joinURL, N as appendResponseHeader, O as withQuery, P as sanitizeStatusCode, Q as withTrailingSlash, R as withoutTrailingSlash, S as getContext, T as withLeadingSlash, U as parseURL, c as createError$1, $ as $fetch$1, V as baseURL, W as createHooks, X as executeAsync, Y as encodeParam, Z as encodePath, _ as toRouteMatcher, a0 as createRouter$1 } from '../_/nitro.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderComponent, ssrRenderClass, ssrRenderStyle, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr, ssrRenderSuspense } from 'vue/server-renderer';
import { useForwardPropsEmits, Primitive, ProgressRoot, ProgressIndicator, Slot, useForwardProps, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose } from 'reka-ui';
...
const __nuxt_page_meta = {
  layout: false
  // Use no layout for maintenance page
};
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-ClhuAam2.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-0-Og1yXl.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-CFPxWaKR.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-su2PDVfz.mjs')
  },
  {
    name: "wishlist",
    path: "/wishlist",
    component: () => import('./wishlist-DURxyfNo.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { "middleware": "guest" },
    component: () => import('./login-ClQs5IAy.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-D3ZcMu8L.mjs')
  },
  {
    name: "shop",
    path: "/shop",
    component: () => import('./index-DjWjplxk.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-D3oRMps2.mjs')
  },
  {
    name: "maintenance",
    path: "/maintenance",
    meta: __nuxt_page_meta || {},
    component: () => import('./maintenance-BeYB042g.mjs')
  },
  {
    name: "account",
    path: "/account",
    meta: { "middleware": ["auth"] },
    component: () => import('./index-BKDzSnrt.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import('./register-12dxJehC.mjs')
  },
  {
    name: "payment-failed",
    path: "/payment/failed",
    component: () => import('./failed-GeAtladI.mjs')
  },
  {
    name: "payment-success",
    path: "/payment/success",
    component: () => import('./success-Dg6FMIoz.mjs')
  },
  {
    name: "categories-slug",
    path: "/categories/:slug()",
    component: () => import('./_slug_-CMiSO4eo.mjs')
  },
  {
    name: "payment-cancelled",
    path: "/payment/cancelled",
    component: () => import('./cancelled-DTTSrsPA.mjs')
  },
  {
    name: "order-confirmation",
    path: "/order-confirmation",
    component: () => import('./order-confirmation-DcUGjEPF.mjs')
  },
  {
    name: "shop-product-slug",
    path: "/shop/product/:slug()",
    component: () => import('./_slug_-6f4qSmrn.mjs')
  },
  {
    name: "blog-category-name",
    path: "/blog/category/:name()",
    component: () => import('./_name_-BaIOTCQB.mjs')
  },
  {
    name: "shop-category-category",
    path: "/shop/category/:category()",
    component: () => import('./_category_-CKDP6nXM.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-DgssJ_3L.mjs'),
  guest: () => import('./guest-CsQEy2H1.mjs')
};
...
const ipxRuntime$WX8231A7nPxSMxsr1u8HZxhPgr7G2UOREqME0EB_45X30 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$WX8231A7nPxSMxsr1u8HZxhPgr7G2UOREqME0EB_45X30, defaults: {} }
  }
};
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(__nuxt_component_6)), mergeProps({
                role: "img",
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(__nuxt_component_6)), mergeProps({
                key: 0,
                role: "img",
                src: __props.src,
                alt: __props.alt,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BI7cJY7k.mjs').then((m) => m.default || m))
};
...
const useSettings = () => {
  ...
  const fetchBranding = () => {
    return useFetch(`${apiBase}settings/branding`, {
      key: "branding",
      lazy: true
    }, "$4eodhBBlZh");
  };
  const fetchSiteSettings = () => {
    return useFetch(`${apiBase}settings/site`, {
      key: "site-settings",
      lazy: true
    }, "$uXYtQyqFUM");
  };
  const fetchSEO = () => {
    return useFetch(`${apiBase}settings/seo`, {
      key: "seo-settings",
      lazy: true
    }, "$025ukfDJal");
  };
  const fetchSocialMedia = () => {
    return useAsyncData("social-media", async () => {
      return await $fetch(`${apiBase}settings/social-media`);
    }, {
      server: true,
      getCachedData: (key) => useNuxtApp().static.data[key] ?? useNuxtApp().payload.data[key]
    });
  ...
  const fetchFooterSettings = () => {
    return useFetch(`${apiBase}settings/footer`, {
      key: "footer-settings",
      lazy: true
    }, "$n05oK_e2Bl");
  };
...
const useSEO = (options = {}) => {
  ...
  const pageImage = computed(
    () => options.image || settings?.value?.branding?.og_image || settings?.value?.branding?.logo || ""
  );
  ...
  const pageKeywords = computed(() => {
    ...
    const pageKeywords2 = options.keywords || "";
    return pageKeywords2 ? `${pageKeywords2}, ${siteKeywords}` : siteKeywords;
  });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: settings, pending, error } = ([__temp, __restore] = withAsyncContext(() => fetchSettings()), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(settings)?.seo.google_tag_manager_id) {
              _push2(`<noscript${_scopeId}><iframe${ssrRenderAttr("src", `https://www.googletagmanager.com/ns.html?id=${unref(settings).seo.google_tag_manager_id}`)} height="0" width="0" style="${ssrRenderStyle({ "display": "none", "visibility": "hidden" })}"${_scopeId}></iframe></noscript>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              unref(settings)?.seo.google_tag_manager_id ? (openBlock(), createBlock("noscript", { key: 0 }, [
                createVNode("iframe", {
                  src: `https://www.googletagmanager.com/ns.html?id=${unref(settings).seo.google_tag_manager_id}`,
                  height: "0",
                  width: "0",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DPs66WUS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DP_oRoB1.mjs'));
...
export { formLoadingInjectionKey as $, useUserSession as A, __nuxt_component_2$1 as B, useComponentIcons as C, looseToNumber as D, _sfc_main$7 as E, useState as F, usePortal as G, useFieldGroup as H, isArrayOfArray as I, _sfc_main$c as J, getDisplayValue as K, useLocale as L, compare as M, _sfc_main$9 as N, pickLinkProps as O, _sfc_main$a as P, useRuntimeConfig as Q, defineNuxtRouteMiddleware as R, useFetch as S, formErrorsInjectionKey as T, formInputsInjectionKey as U, inputIdInjectionKey as V, formFieldInjectionKey as W, omit as X, formBusInjectionKey as Y, formStateInjectionKey as Z, __nuxt_component_0$1 as _, useToast as a, formOptionsInjectionKey as a0, useRouter as b, useSEO as c, _sfc_main$e as d, entry$1 as default, _sfc_main$8 as e, __nuxt_component_6 as f, useImage as g, useBaseImage as h, getFileExtension as i, baseImageProps as j, prerenderStaticImages as k, useRequestEvent as l, useNuxtApp as m, useNuxtData as n, useAppConfig as o, pictureProps as p, useFormField as q, get as r, useSeoMeta as s, tv as t, useHead as u, navigateTo as v, useAsyncData as w, useRoute as x, _sfc_main$b as y, useSettings as z };
